...
<html>
	<head>
		<title>Portfolio | Reimer Carpentry</title>
		<meta charset="utf-8" />
...
//xenrin.deviantart.com" title="deviantart" class="icon fa-deviantart"><span class="label">deviantArt</span></a></li>
		...
		<!-- Main -->
			<div id="main">
				...
				<!-- Intro -->
					<section id="top" class="one dark cover carpentry">
						<div class="container">

							<header>
								<h2 class="alt">Reimer Carpentry</h2>
								<p>Business cards &amp; branding</p>
							</header>
				...
				<!-- About Me -->
					<section id="info" class="two">
						<div class="container">
							...
							<p>Even though I don't consider myself to be a graphic designer, I often have people asking me to do graphic designs for them. Business cards &amp; logos mostly. Luckily for me, graphic &amp; web design are closely related and both were part of my college education (and my current skill-set).</p>

							<h3>Technologies</h3>
							<p>These business cards were put together using a combination of <strong>Adobe Illustrator</strong> &amp; <strong>Photoshop</strong>. A PDF was then exported and sent to <a href="
//www.jukeboxprint.com/">Jukebox</a> for printing. I even received an email from Jukebox asking if my design could be used in promotional material.</p>
						...
						<div class="container">
							...
							<div class="row">
								<div class="4u 12u$(mobile)">
									<article class="item">
										<a href="javascript:void(0)" class="image fit"><img src="images/sc-carpentry-front.jpg" alt="" /></a>
									</article>
								</div>

								<div class="4u 12u$(mobile)">
									<article class="item">
										<a href="javascript:void(0)" class="image fit"><img src="images/sc-carpentry-both.jpg" alt="" /></a>
									</article>
								</div>

								<div class="4u$ 12u$(mobile)">
									<article class="item">
										<a href="javascript:void(0)" class="image fit"><img src="images/sc-carpentry-back.jpg" alt="" /></a>
									</article>
								</div>
							</div>
